...
Ajouter les seize catégories de Chenhall
https://page.nomenclature.info/apropos-about.app?lang=en#Heading-About



Dans leur article, DANIEL BELTEKI, ARRAN J. REES, ANNA-MARIA SICHANI analysent la transition des institutions patrimoniales vers une approche de « collections-as-data » (cours 4), où les archives et objets deviennent des ressources exploitables par le calcul informatique. Les auteurs utilisent la métaphore de l'iceberg des données pour révéler que le succès des outils numériques dépend d'un travail invisible et colossal de gestion des collections, incluant le catalogage et la documentation. L'étude identifie trois piliers essentiels à la réussite de cette transformation : l'harmonisation des normes pour assurer l'interopérabilité, la gestion de l'échelle face aux disparités de ressources entre institutions, et le renforcement des compétences numériques du personnel. En explorant l'infrastructure technologique du Royaume-Uni, le texte plaide pour une reconnaissance accrue de ces tâches de l'ombre afin de bâtir une collection nationale numérique véritablement accessible et réutilisable.


### DOPHEDA : le modèle du RCIP pour les collections canadiennes

- **DO**nnées **P**atrimoniales **HE**ritage **DA**ta, projet du Réseau canadien d'information sur le patrimoine (RCIP)
- Objectif : représenter les données et la documentation des établissements canadiens en **données ouvertes et liées**
- Fondé sur **CIDOC-CRM**
- Deux facettes : **Actants** (personnes, groupes) et **Objets**
- Volet Objets prévu pour s'aligner sur **linked.art**

**Question** : pourquoi commencer par les personnes et les groupes plutôt que par les objets ?

/** Notes **/

Voici un exemple canadien de tout ce que nous venons de voir : un organisme fédéral qui développe un modèle sémantique pour les collections des musées du pays. Le nom vient de DOnnées PatrimonialEs HEritage DAta, et il sert aussi de nom de domaine pour les identifiants.

Le RCIP a choisi de commencer par les actants, c'est-à-dire les personnes et les groupes liés aux objets : artistes, artisans, manufacturiers, collectifs. La raison donnée dans la documentation : il existe peu de jeux de données patrimoniales centrés sur les personnes, alors que les données institutionnelles sont surtout centrées sur les objets. C'est aussi une bonne réponse à notre discussion sur le champ « artiste » : un actant a une existence propre, avec des événements de vie et des relations, et pas seulement une ligne de texte dans une fiche d'objet.

Le choix du CIDOC-CRM repose sur trois critères indiqués par le RCIP : l'adoption par la communauté du patrimoine sémantique, la richesse et la durabilité de l'ontologie, et sa capacité à représenter des données centrées sur les objets.

Autre point utile : le RCIP a publié un rapport sur la structure des URI, ces identifiants qui permettent de désigner sans ambiguïté un acteur, un objet ou un terme de vocabulaire. Nous y reviendrons aux séances 6 et 10.

Ressource : https://chin-rcip.github.io/collections-model/fr
...
- Plan : doit etre mise a jour. et partager a d'autres personnes : securité /** Notes **/
